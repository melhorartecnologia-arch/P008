...
import { Download, Upload, FileSpreadsheet, X, AlertTriangle, CheckCircle2 } from 'lucide-react'

import { authHeaders } from '../api.js'

const BASE = import.meta.env.VITE_API_BASE || '/api'

export default function ImportTiposModal({ onCancel, onImported }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch(
        `${BASE}/tipos-entrada-saida/import?mode=${mode}`,
      ...
      <form className="modal modal-lg" onSubmit={handleSubmit}>
        <div className="modal-head">
          ...
          <p>Carregue um arquivo <code>.xlsx</code> com as colunas
            <strong> codigo</strong>, <strong>descricao</strong> e
            <strong> considera_analise</strong>.
          </p>
        </div>
          ...
          {!result && (
            <>
              <div className="import-hint">
                ...
                <a
                  href={`${BASE}/tipos-entrada-saida/template.xlsx`}
