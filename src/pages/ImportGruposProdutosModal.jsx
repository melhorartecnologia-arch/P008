...
export default function ImportGruposProdutosModal({ onCancel, onImported }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch(
        `${BASE}/grupos-produtos/import?mode=${mode}`,
          ...
          {!result && (
            <>
              <div className="import-hint">
                ...
                <a href={`${BASE}/grupos-produtos/template.xlsx`} className="link-primary">
              ...
              <div className="import-mode">
                ...
                <label>
                  <input type="radio" name="mode" value="insert"
                    checked={mode === 'insert'} onChange={() => setMode('insert')} />
