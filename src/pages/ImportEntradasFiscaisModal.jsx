...
export default function ImportEntradasFiscaisModal({ onCancel, onImported }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch(`${BASE}/entradas-fiscais/import`, { method: 'POST', body: form, headers: authHeaders() })
    ...
    <div className="modal-backdrop" onMouseDown={(e) => {
      ...
      <form className="modal modal-lg" onSubmit={handleSubmit}>
        <div className="modal-head">
          ...
          <p>Carregue um arquivo <code>.xlsx</code> com as 16 colunas do cadastro.
            Campos obrigatórios: <strong>codigo_filial</strong>,
            <strong> item_documento_fiscal</strong>, <strong>codigo_produto</strong>,
            <strong> numero_documento_fiscal</strong>.</p>
        </div>
          ...
          {!result && (
            <>
              <div className="import-hint">
                ...
                <a href={`${BASE}/entradas-fiscais/template.xlsx`} className="link-primary">
